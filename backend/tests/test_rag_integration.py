...
class TestRAGSystemIntegration(unittest.TestCase):
    ...
    def test_query_with_empty_database(self):
        ...
        self.mock_ai_generator.generate_response.return_value = "I don't have any course materials loaded."
    ...
    def test_add_course_and_query_flow(self):
        ...
        self.mock_ai_generator.generate_response.return_value = "Python is a programming language used for development."
    ...
    def test_query_failure_scenarios(self):
        ...
        test_cases = [
            ...
            # Case 2: Tool manager returns error
            {
                ...
                "setup": lambda: (
                    setattr(self.mock_ai_generator.generate_response, 'return_value', "Tool result"),
                    setattr(self.rag_system.tool_manager.get_last_sources, 'return_value', [])
                ),
...
def run_all_tests():
    ...
    # Add test classes
    for test_class in [TestRAGSystemIntegration, TestRAGSystemErrorScenarios, TestRAGSystemWithMockComponents]:
